...
import static com.playdata.userservice.user.entity.QTerms.terms;
...
public class TermsRepositoryImpl implements TermsRepositoryCustom {
     ...
     */
    @Override
    public Page<TermsListResDto> findByTermsList(TermsCategory termsCategory, Pageable pageable) {
