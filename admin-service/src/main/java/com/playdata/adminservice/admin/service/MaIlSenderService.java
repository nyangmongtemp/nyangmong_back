...
public class MaIlSenderService {
     ...
     */
    // 로그인 인증코드를 이메일로 전송하는 로직
    public String loginMain (String email) throws MessagingException {
        String setFrom = "secun77@gmail.com";
        String id = String.valueOf(((int)(Math.random() * 9000) + 1000));
        String toMail = email;
        String title = " 냥몽 관리자 로그인 인증 이메일";
        String content = "냥몽 관리자 로그인 인증 번호 이메일 입니다." +
                "<br><br>" +
